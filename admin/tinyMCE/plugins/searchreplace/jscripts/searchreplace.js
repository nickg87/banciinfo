...
function searchNext(replacemode) {
	...
	var task = (document.getElementById("searerad_tab").className == "current") ? "search" : "replace";
...
function copyValues(link) {
	...
	var from_panel_name = tab.id.match(/^search/i) ? "replace_panel" : "searerad_panel";
	var to_panel_name = (from_panel_name == "searerad_panel") ? "replace_panel" : "searerad_panel";
