...
var TinyMCE_SearchReplacePlugin = {
	...
	initInstance : function (inst) {
		inst.addShortcut('ctrl', 'f', 'lang_searchreplace_searerad_desc', 'mceSearch', true);
	...
	getControlHTML : function (cn) {
		switch (cn) {
			case "search" :
				return tinyMCE.getButtonHTML(cn, 'lang_searchreplace_searerad_desc', '{$pluginurl}/images/search.gif','mceSearch', true);
	...
	execCommand : function (editor_id, element, command, user_interface, value) {
		...
		function replaceSel(searerad_str, str, back) {
