        	...
        	<div id="prd" class="box_produse"  >
                <? if($it[$i][produs_nou]==1) {?>
                 ...
                 <? if($it[$i][pret_oferta]>0) {?>
                        <? if($it[$i][pret]>0) {?><span class="pret_taiat" ><?=$it[$i][pret]?> lei&nbsp;</span> 
                        <br />
 
                        <? }?>
                        <span class="pret_normal" ><strong><?=$it[$i][pret_oferta]?></strong> lei&nbsp;</span> 
        <? } else {?>
        <span   style="width:155px; height:35px; margin:0 auto;   border-bottom:1px solid #ccc;  border-top:1px dotted #efefef;">
        <? if($it[$i][pret]>0) {?>
        </span>
        <strong><span class="pret_normal"><?=$it[$i][pret]?>lei </span></strong> &nbsp;<? }?>
             <? }?>
                    </div>           </td>
           </tr>
           </table>
